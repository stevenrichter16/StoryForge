//
//  EnhancedRelationshipLine.swift
//  StoryForge
//
...
// MARK: - Enhanced Relationship Line
struct EnhancedRelationshipLine: View {
    ...
    private var lineWidth: CGFloat {
        ...
        return baseWidth / zoom // Adjust for zoom
    }
        ...
        ZStack {
            ...
            if isHighlighted {
                Text(relationship.relationshipType)
                    ...
                    .scaleEffect(1.0 / zoom) // Keep readable at all zoom levels
            }
        }
    }
}
